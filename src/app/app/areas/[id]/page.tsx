...
export default function AreaPage() {
 ...
 <div className="px-4 lg:px-6 py-3 border-b border bg-background flex items-center gap-3">
 <button
 type="button"
 onClick={() => router.back()}
 ...
 <IconHash size={20} className="text-muted-foreground shrink-0" />
 ...
 <p className=" text-muted-foreground">Nenhuma tarefa nesta área</p>
 </div>
 )}
