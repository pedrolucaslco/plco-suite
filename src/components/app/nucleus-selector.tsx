  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1.5 text-sm text-ink-mid hover:text-ink transition-colors max-w-[180px]"
      >
      ...
      {open && (
        <>
          ...
          <div className="absolute left-0 top-full mt-1 z-50 w-48 bg-popover border border-hairline rounded-lg shadow-lg py-1">
            {nuclei.map((n) => (
              <button
                key={n.id}
                type="button"
