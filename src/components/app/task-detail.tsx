...
export function TaskDetail({
 ...
 className="font-bold border-0 px-0 h-auto focus-visible:ring-0"
 />
 ...
 className="w-full h-9 rounded-md border border bg-background text-foreground px-3 focus:outline-none focus:ring-2 focus:ring-primary/30"
 >
 {SECTIONS.map((s) => (
